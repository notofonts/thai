...
<details><summary>[12] NotoSansThaiUI[wdth,wght].ttf</summary>
<div>
<details>
...
* 🔥 **FAIL** <p>.notdef glyphs were found when attempting to render Noto Sans Thai UI</p>
...
* ⚠️ **WARN** <p>Family metadata at fonts/NotoSansThaiUI/googlefonts/variable-ttf does not have an article.</p>
 [code: lacks-article]
...
definitions.</p>
<ul>
<li>U+2010 HYPHEN: try adding one of: kharoshthi, yi, hebrew, kaithi, cham, sora-sompeng, sundanese, arabic, armenian, kayah-li, coptic, lisu, syloti-nagri</li>
</ul>
...
<pre><code>* uni0E5A (U+0E5A): X=332.0,Y=-1.0 (should be at baseline 0?)

* uni0E5A (U+0E5A): X=421.0,Y=-1.0 (should be at baseline 0?)

* uni0E5A (U+0E5A): X=580.0,Y=-1.0 (should be at baseline 0?)

* uni0E5A (U+0E5A): X=669.0,Y=-1.0 (should be at baseline 0?)

* nikhahit_maiChattawathai: X=-160.0,Y=715.0 (should be at cap-height 714?)

* nikhahit_maiChattawathai.narrow: X=-319.0,Y=715.0 (should be at cap-height 714?)

* nikhahit_maiEkthai: X=-160.0,Y=715.0 (should be at cap-height 714?)

* nikhahit_maiEkthai.narrow: X=-320.0,Y=715.0 (should be at cap-height 714?)

* nikhahit_maiThothai: X=-160.0,Y=715.0 (should be at cap-height 714?)

* nikhahit_maiThothai.narrow: X=-319.0,Y=715.0 (should be at cap-height 714?)

* nikhahit_maiTrithai: X=-160.0,Y=715.0 (should be at cap-height 714?)

* nikhahit_maiTrithai.narrow: X=-320.0,Y=715.0 (should be at cap-height 714?)
...
* 🔥 **FAIL** <p>OS/2.fsSelection bit 7 (USE_TYPO_METRICS) wasNOT set in the following fonts: ['fonts/NotoSansThaiUI/googlefonts/variable-ttf/NotoSansThaiUI[wdth,wght].ttf'].</p>
